...
async def start_stream_audio(
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"🎬<b>__Ses:__ </b> [Verilen Ses İle Telegram]({link})\n⏳<b>__Süre:__</b> {duration_min} \n👤<b>__Tarafından Talep edilen:__ </b>{message.from_user.mention} \n🚧<b>__Sıraya alındı:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Oynuyor:__ </b>[Ses Üzerinden Verilen Telegram]({link})\n👤**__Tarafından Talep edilen:__** {message.from_user.mention}"
        final_output = await message.reply_photo(
            photo="Utils/Telegram.JPEG",
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
